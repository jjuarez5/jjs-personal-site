...
function Header() {
  return (
    <div className="w-full sticky -top-0 z-0 font-semibold inline-flex flex-1 bg-purple-900 text-zinc-100 p-1 drop-shadow-lg">
      <AnchorLink className="no-underline" href="#home">
        <h1 className="text-5xl">
          <FaLaptopCode className="inline-block mx-1 mr-3 mb-2 hover:text-blue-400" />
        </h1>
      </AnchorLink>
