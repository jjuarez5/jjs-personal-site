...
function About() {
  return (
    <div
      className="bg-zinc-100 flex flex-row border-y-2 border-zinc-300"
      id="home"
    >
      <div className="flex flex-col mr-10 mx-10">
        <div className="flex flex-row mr-20 mr-0.5 mb-5 mt-5">
          ...
          <div className="text-2xl text-purple-400 mx-1">
            <h2>my name is</h2>
          </div>
        </div>
        <div className="flex flex-col px-1">
          <div className="text-5xl text-purple-400 bp">
          ...
          <div className="text-2xl text-black mb-4">
            <h2 className="flex flex-row">
              ...
              <a href="https://github.com/jjuarez5">
                <SiGithub className="hover:text-purple-400 mx-1" />
              </a>
              <a href="https://www.linkedin.com/in/juliojuarez713/">
                <SiLinkedin className="hover:text-purple-400 mx-1" />
              </a>
            </h2>
          </div>
          <div className="flex flex-row py-1 mb-5 text-black text-justify text-xl">
            <p>
