...
function Contact() {
  ...
  return (
    <div
      id="contact"
      style={{ position: "relative", zIndex: 10, padding: "100px 80px" }}
    >
      {/* Header */}
      <div
        style={{
      ...
      >
        ...
        <div>
          ...
          >
            Build Something
            <br />
            <span style={{ color: orange }}>Together</span>
          </h3>
          <p
            style={{
              fontSize: "12px",
          ...
          >
            ...
            >
              <div style={{ color: dim }}>
                <span style={{ color: orange }}>const</span> developer = {"{"}
              </div>
              <div style={{ color: dim }}>
                &nbsp;&nbsp;name:{" "}
                <span style={{ color: "rgba(200,255,200,0.7)" }}>
                  "Julio Juarez"
                </span>
                ,
              </div>
              ...
              <div style={{ color: dim }}>
                &nbsp;&nbsp;coffee:{" "}
                <span style={{ color: "rgba(200,255,200,0.7)" }}>"always"</span>
              </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                boxShadow:
                  "0 0 15px rgba(255,107,0,0.6), 0 0 30px rgba(255,107,0,0.3)",
                transition: "all 0.3s",
                width: "100%",
              }}
              onMouseEnter={(e) => {
