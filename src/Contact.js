  ...
  return (
    <div id="contact" style={{ position: "relative", zIndex: 10, padding: "100px 80px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "60px" }}>
        <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "9px", letterSpacing: "4px", color: orange }}>03 //</span>
        <div style={{ flex: 1, height: "1px", background: `linear-gradient(90deg, ${border}, transparent)` }} />
        <h2 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "clamp(28px,4vw,48px)", fontWeight: 700, letterSpacing: "2px", color: white }}>CONTACT</h2>
      </div>
